    ...
    return(
        <div className="list-item">
            ...
            <button className="delete-todo" style={{display:(dataBtnId == 0) ? 'none' : 'initial'}} >
             <img src="./assets/images/icon-cross.svg"  data-bs-toggle="modal" data-id={dataBtnId} data-bs-target="#modalDeleteItem"  className="imgDeleteTodo" alt="" onClick={changeModal} />
            </button>
        </div>
